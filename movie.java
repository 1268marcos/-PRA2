...
/**
 ...
 [3] Arquitetura do aplicativo
     ...
     MovieActivity > MovieViewModel > MovieRepository > MovieDao > DbRoomDatabase > SQlite
...
/**
 ...
 O nome da tabela 'movies' deverá ser informada no objeto Database. Se após a primeira
 execução com sucesso do aplicativo haver a necessidade de alguma mudança na estrutura
 de dados que foi definida AQUI nesta classe 'Movie' uma nova versão do banco de dados
 ...
 Detalhe importante [1] - os dados contidos na tabela 'movies' e em outras tabelas
...
/**
     ...
     public void setTitle(String title) {
        mTitle = title.toUpperCase().trim();
     }
     Clique com o botão direito do mouse sobre o nome da classe 'Movie' e escolha
